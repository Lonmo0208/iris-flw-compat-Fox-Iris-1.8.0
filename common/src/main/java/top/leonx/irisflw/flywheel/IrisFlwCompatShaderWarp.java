...
public class IrisFlwCompatShaderWarp {
    ...
    protected GlUniformMcMatrix4fc uniformIrisProjMat;
    protected GlUniformMcMatrix4fc iris_uniformModelViewMat;
    //protected GlUniformMcMatrix4fc uniformModelViewMat;
    protected GlUniformMcMatrix3f uniformNormalMatrix;
    protected GlUniformMcMatrix4fc uniformModelViewProjMat;
    ...
    public IrisFlwCompatShaderWarp(ShaderInstance shader) {
        ...
        if(shader.MODEL_VIEW_MATRIX == null){
            ...
            shader.MODEL_VIEW_MATRIX.set(new Matrix4fc());
        }

        uniformIrisProjMat = new GlUniformMcMatrix4fc(GL20.glGetUniformLocation(progId,"iris_ProjMat"));
        iris_uniformModelViewMat = new GlUniformMcMatrix4fc(GL20.glGetUniformLocation(progId,"iris_ModelViewMat"));
    ...
    public void setModelViewMatrix(Matrix4fc modelView) {
        ...
        if (this.uniformNormalMatrix != null) {
            Matrix4fc normalMatrix = new Matrix4fc(modelView);
            normalMatrix.invert();
